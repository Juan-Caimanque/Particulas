...
int main() {
    ...
    std::string nombre_salida = "salida_" + fecha + "_no_filtrada.root";
    TFile *archivo_salida = new TFile(nombre_salida.c_str(), "RECREATE");
    TTree *tree = new TTree("hits", "Eventos");
...
// g++ multiplano_no_restriction.cpp $(root-config --cflags --libs) -o multi_no_restrict
// ./multi_no_restrict
...
// TFile *f = TFile::Open("salida_2024_09_07_no_filtrada.root");  // Usa tu archivo real
// TTree *t = (TTree*)f->Get("hits");
// t->Draw("barra_A_2:barra_B_2 >> h2d(13,0.5,13.5,13,0.5,13.5)", "", "COLZ");
// c1->SaveAs("heatmap_A2_vs_B2_no_filtrada.png");
