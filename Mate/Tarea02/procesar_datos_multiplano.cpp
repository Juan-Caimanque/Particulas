...
int main() {
    ...
    std::string nombre_salida = "salida_" + fecha + "_filtrada.root";
    TFile *archivo_salida = new TFile(nombre_salida.c_str(), "RECREATE");
    TTree *tree = new TTree("hits_validados", "Eventos válidos con 1 hit por plano");
...
// g++ procesar_datos_multiplano.cpp $(root-config --cflags --libs) -o procesar_datos
// ./procesar_datos
...
// TFile *f = TFile::Open("salida_2024_09_07_filtrada.root");  // Usa tu archivo real
// TTree *t = (TTree*)f->Get("hits_validados");
// t->Draw("barra_A_2:barra_B_2 >> h2d(13,0.5,13.5,13,0.5,13.5)", "", "COLZ");
// c1->SaveAs("heatmap_A2_vs_B2_filtrada.png");
