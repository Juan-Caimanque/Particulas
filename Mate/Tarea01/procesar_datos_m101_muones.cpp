...
int main() {
    ...
    TFile *archivo_salida = new TFile("salida_m101_filtrada.root", "RECREATE");
    ...
    std::ifstream archivo_txt("2024_09_07_06h00_mate-m101.txt");
    ...
    std::cout << "Proceso terminado. Archivo 'salida_m101_filtrada.root' creado.\n";
    return 0;
}

//para activar el código, escribir lo siguiente en la Terminal dentro de la carpeta con los archivos:
//
// g++ procesar_datos_m101_muones.cpp $(root-config --cflags --libs) -o procesar
// ./procesar
