...
int main() {
    // Abrir archivo ROOT
    TFile *archivo = new TFile("salida_m101_filtrada.root", "READ");
    ...
    // Crear histograma 2D
    TH2I *h2 = new TH2I("h2", "Mapa de calor - Hits en m101 - Sin Casos Especiales", 
    ...
    c1->Update();
    c1->SaveAs("heatmap_m101.png"); // (opcional) exportar imagen
...
// g++ generar_histograma_m101.cpp $(root-config --cflags --libs) -o histograma
// ./histograma
