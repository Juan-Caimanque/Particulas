...
int main() {
    // Abrir archivo ROOT
    TFile *archivo = new TFile("salida_m103_filtrada.root", "READ");
    ...
    // Crear histograma 2D
    TH2I *h2 = new TH2I("h2", "Mapa de calor - Hits en m103 - Sin Casos Especiales", 
    ...
    c1->Update();
    c1->SaveAs("heatmap_m103.png"); // (opcional) exportar imagen
...
// g++ generar_histograma_m103.cpp $(root-config --cflags --libs) -o histograma
// ./histograma
